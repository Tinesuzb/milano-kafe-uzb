...
import { ShoppingBag, Users, Eye, Check, Clock, CheckCircle, RefreshCw } from "lucide-react"
  ...
  const updateOrderStatus = async (orderId: number, status: string) => {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          title: t("success"),
          description: ` uczni_order holati ${getStatusText(status)} ga o'zgartirildi`,
        })
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-3 md:ml-4">
                  <p className="text-xs md:text-sm font-medium text-gray-600">Yakunlangan</p>
                ...
                <div className="space-y-6">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        <span className="text-gray-600">Yakunlangan buyurtmalar:</span>
                        <span className="font-semibold ml-2">{completedOrders.length}</span>
                      </div>
                    </div>
                  </div>
